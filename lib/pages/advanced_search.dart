...
class _AdvancedSearch extends State<AdvancedSearch> {
          ...
          child: FutureBuilder<List<Result>>(
              ...
              builder:
                ...
                return snapshot.data!.isEmpty
                    ? const Center(child: Text('No ingredients in fridge'))
                    : ListView(
                        children: snapshot.data!.map((ingredient) {
                          return Padding(
                            ...
                            child: Card(
                              child: ListTile(
                                onTap: () {
                                  showAlertDialogForAddingIngredientToSearchList(
                                      context, ingredient);
                                },
  ...
  void showAlertDialogForAddingIngredientToSearchList(
    ...
    AlertDialog alert = AlertDialog(
      ...
      content:
          const Text("Would you like to find a recipe with this ingredient?"),
      actions: [
        cancelButton,
        continueButton,
      ],
